"""Relation service seed for forecast_review."""
...
RELATED_DOCS = [{'doc_id': 'sales_forecast', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'target_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_commitment', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'forecast'}, {'description': 'target identity from linked docs'}]
