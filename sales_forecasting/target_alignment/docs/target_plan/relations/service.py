"""Relation service seed for target_plan."""
...
DOC_ID = "target_plan"
RELATED_DOCS = [{'doc_id': 'sales_forecast', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_review', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
