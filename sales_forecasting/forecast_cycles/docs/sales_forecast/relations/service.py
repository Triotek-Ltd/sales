"""Relation service seed for sales_forecast."""
...
RELATED_DOCS = [{'doc_id': 'forecast_line', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_commitment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'target_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_review', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'pipeline commitments from forecast_commitment'}]
