"""Business-domain service seed for Forecast Line."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds production planning, demand planning, budgeting, and management reporting'], 'related_docs': ['sales_forecast', 'forecast_commitment', 'opportunity_record'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
