"""Relation service seed for forecast_line."""
...
RELATED_DOCS = [{'doc_id': 'sales_forecast', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_commitment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'opportunity values'}, {'description': 'commitments from linked records'}]
