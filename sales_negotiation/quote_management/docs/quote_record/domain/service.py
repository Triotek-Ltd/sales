"""Business-domain service seed for Quote Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'submitted', 'approved', 'accepted', 'expired', 'cancelled', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'issue_date': 'schedule_marker', 'validity_date': 'schedule_marker', 'related_lead_record': 'relation_collection', 'related_customer_account': 'relation_collection', 'related_deal_negotiation_case': 'relation_collection', 'related_pricing_exception_request': 'relation_collection', 'related_opportunity_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'quote_code', 'customer_or_lead', 'issue_date'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'submitted', 'approved', 'accepted', 'expired', 'cancelled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'issue': None, 'accept': None, 'expire': None, 'cancel': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds order capture, billing, and relationship management'], 'related_docs': ['lead_record', 'customer_account', 'deal_negotiation_case', 'pricing_exception_request', 'opportunity_record'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'issue': None, 'accept': None, 'expire': None, 'cancel': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
