"""Relation service seed for quote_record."""
...
DOC_ID = "quote_record"
RELATED_DOCS = [{'doc_id': 'lead_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'deal_negotiation_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_exception_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'target party details from lead_record or customer_account'}]
