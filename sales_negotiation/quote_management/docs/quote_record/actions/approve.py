"""Action handler seed for quote_record:approve."""
...
DOC_ID = "quote_record"
ACTION_ID = "approve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'accepted', 'expired', 'cancelled'], 'transitions_to': 'approved'}
