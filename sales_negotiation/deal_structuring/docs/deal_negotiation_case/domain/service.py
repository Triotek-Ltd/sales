"""Business-domain service seed for Deal Negotiation Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'negotiating', 'agreed', 'lost', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_quote_record': 'relation_collection', 'related_opportunity_record': 'relation_collection', 'related_pricing_exception_request': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'linked_quote_or_opportunity', 'negotiation_stage'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'negotiating', 'agreed', 'lost', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'review': None, 'counter': None, 'agree': None, 'lose': None, 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['quote_record', 'opportunity_record', 'pricing_exception_request'], 'action_targets': {'create': None, 'assign': None, 'review': None, 'counter': None, 'agree': None, 'lose': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
