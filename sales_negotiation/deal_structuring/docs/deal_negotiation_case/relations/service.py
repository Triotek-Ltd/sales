"""Relation service seed for deal_negotiation_case."""
...
RELATED_DOCS = [{'doc_id': 'quote_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_exception_request', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'commercial terms from quote_record'}, {'description': 'deal value from opportunity_record'}]
