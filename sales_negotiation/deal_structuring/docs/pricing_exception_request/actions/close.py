"""Action handler seed for pricing_exception_request:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'rejected'], 'transitions_to': 'closed'}
