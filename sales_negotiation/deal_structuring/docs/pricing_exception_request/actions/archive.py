"""Action handler seed for pricing_exception_request:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'rejected'], 'transitions_to': 'archived'}
