"""Action handler seed for pricing_exception_request:review."""
...
ACTION_ID = "review"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'rejected'], 'transitions_to': None}
