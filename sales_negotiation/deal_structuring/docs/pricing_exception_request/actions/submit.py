"""Action handler seed for pricing_exception_request:submit."""
...
ACTION_ID = "submit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'rejected'], 'transitions_to': 'submitted'}
