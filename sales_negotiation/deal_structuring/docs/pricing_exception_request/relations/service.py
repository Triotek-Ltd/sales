"""Relation service seed for pricing_exception_request."""
...
RELATED_DOCS = [{'doc_id': 'quote_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_decision', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'base commercial terms from quote_record'}]
