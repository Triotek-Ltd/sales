...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'approver': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'request_code', 'linked_quote', 'requested_variance'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'submitted', 'approved', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'submit': 'submitted', 'review': None, 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
