"""Business-domain service seed for Pricing Exception Request."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['draft', 'submitted', 'approved', 'rejected', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'approver': 'actor_reference', 'related_quote_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'request_code', 'linked_quote', 'requested_variance'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'submitted', 'approved', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'submit': 'submitted', 'review': None, 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['quote_record', 'pricing_decision'], 'action_targets': {'create': None, 'submit': 'submitted', 'review': None, 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
