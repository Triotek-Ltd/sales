"""Action handler seed for qualification_case:disqualify."""
...
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'in_review', 'qualified', 'disqualified'], 'transitions_to': None}
...
def handle_disqualify(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
