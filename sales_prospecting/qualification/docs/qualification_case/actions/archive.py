"""Action handler seed for qualification_case:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'in_review', 'qualified', 'disqualified'], 'transitions_to': 'archived'}
