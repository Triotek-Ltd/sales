"""Action handler seed for qualification_case:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'in_review', 'qualified', 'disqualified'], 'transitions_to': 'closed'}
