"""Relation service seed for qualification_case."""
...
RELATED_DOCS = [{'doc_id': 'lead_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'outreach_activity', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'lead source'}, {'description': 'segment from lead_record'}]
