"""Business-domain service seed for Prospect List."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'active', 'closed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'owner': 'actor_reference', 'related_lead_record': 'relation_collection', 'related_outreach_activity': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'list_code', 'campaign_or_territory_scope', 'owner'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'active', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'review': None, 'activate': 'active', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['lead_record', 'outreach_activity'], 'action_targets': {'create': None, 'review': None, 'activate': 'active', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
