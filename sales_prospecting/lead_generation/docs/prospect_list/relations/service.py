"""Relation service seed for prospect_list."""
...
RELATED_DOCS = [{'doc_id': 'lead_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'outreach_activity', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'segment or campaign context from marketing docs'}]
