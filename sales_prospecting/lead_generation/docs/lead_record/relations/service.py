"""Relation service seed for lead_record."""
...
DOC_ID = "lead_record"
RELATED_DOCS = [{'doc_id': 'prospect_list', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'outreach_activity', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'qualification_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source-campaign context from lead_capture_record where applicable'}]
