"""Business-domain service seed for Lead Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'entity_lifecycle', 'case_management': False}, 'reporting_profile': {'supports_snapshots': False, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['new', 'contacted', 'qualified', 'disqualified', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'related_prospect_list': 'relation_collection', 'related_outreach_activity': 'relation_collection', 'related_qualification_case': 'relation_collection', 'related_opportunity_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'lead_code', 'name_or_organization', 'source'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'new', 'lifecycle_states': ['new', 'contacted', 'qualified', 'disqualified', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'assign': None, 'qualify': None, 'disqualify': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds opportunity, negotiation, and forecast workflows'], 'related_docs': ['prospect_list', 'outreach_activity', 'qualification_case', 'opportunity_record'], 'action_targets': {'create': None, 'update': None, 'assign': None, 'qualify': None, 'disqualify': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
