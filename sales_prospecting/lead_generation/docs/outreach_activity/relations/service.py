"""Relation service seed for outreach_activity."""
...
RELATED_DOCS = [{'doc_id': 'lead_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'qualification_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'target identity from lead_record or customer_account'}]
