"""Action handler seed for opportunity_record:advance."""
...
ACTION_ID = "advance"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['identified', 'qualified', 'proposal', 'negotiation', 'won', 'lost'], 'transitions_to': None}
...
def handle_advance(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
