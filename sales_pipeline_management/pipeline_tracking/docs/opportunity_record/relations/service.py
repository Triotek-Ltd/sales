"""Relation service seed for opportunity_record."""
...
RELATED_DOCS = [{'doc_id': 'lead_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'quote_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pipeline_stage_history', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_commitment', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account or lead identity from linked records'}]
