"""Business-domain service seed for Pipeline Stage History."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'changed_at': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'history_code', 'opportunity', 'from_stage'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['opportunity_record'], 'borrowed_fields': ['current opportunity identity from opportunity_record'], 'inferred_roles': ['account owner']}, 'actors': ['account owner'], 'action_actors': {'record': ['account owner'], 'archive': ['account owner']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['opportunity_record'], 'action_targets': {'record': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
