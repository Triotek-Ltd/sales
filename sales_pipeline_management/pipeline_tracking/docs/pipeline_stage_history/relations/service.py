"""Relation service seed for pipeline_stage_history."""
...
RELATED_DOCS = [{'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'current opportunity identity from opportunity_record'}]
