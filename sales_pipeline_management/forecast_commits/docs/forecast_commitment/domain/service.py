"""Business-domain service seed for Forecast Commitment."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'reviewed', 'committed', 'revised', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'committed_amount': 'monetary_value', 'related_opportunity_record': 'relation_collection', 'related_sales_forecast': 'relation_collection', 'related_forecast_line': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'commitment_code', 'opportunity_or_rep', 'forecast_period'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'reviewed', 'committed', 'revised', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': 'reviewed', 'commit': None, 'revise': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds production planning, demand planning, budgeting, and management reporting'], 'related_docs': ['opportunity_record', 'sales_forecast', 'forecast_line'], 'action_targets': {'create': None, 'review': 'reviewed', 'commit': None, 'revise': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
