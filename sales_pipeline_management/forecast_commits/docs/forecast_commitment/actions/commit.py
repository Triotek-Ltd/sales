"""Action handler seed for forecast_commitment:commit."""
...
ACTION_ID = "commit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'reviewed', 'committed', 'revised'], 'transitions_to': None}
...
def handle_commit(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
