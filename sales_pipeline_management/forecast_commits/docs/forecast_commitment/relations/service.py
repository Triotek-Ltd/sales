"""Relation service seed for forecast_commitment."""
...
RELATED_DOCS = [{'doc_id': 'opportunity_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sales_forecast', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forecast_line', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'opportunity value'}, {'description': 'stage from opportunity_record'}]
