"""Business-domain service seed for Renewal Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'in_review', 'renewed', 'lost', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'renewal_date': 'schedule_marker', 'owner': 'actor_reference', 'related_account_interaction_log': 'relation_collection', 'related_quote_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_account_or_contract', 'renewal_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'renewed', 'lost', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'renew': 'renewed', 'lose': None, 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['customer_account', 'account_interaction_log', 'quote_record'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'renew': 'renewed', 'lose': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
