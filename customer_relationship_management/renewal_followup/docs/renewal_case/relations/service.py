"""Relation service seed for renewal_case."""
...
DOC_ID = "renewal_case"
RELATED_DOCS = [{'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'account_interaction_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'quote_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account'}, {'description': 'commercial context from linked account/quote records'}]
