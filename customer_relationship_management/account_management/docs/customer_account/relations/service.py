"""Relation service seed for customer_account."""
...
RELATED_DOCS = [{'doc_id': 'contact_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'account_interaction_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'renewal_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_invoice', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'customer identity from upstream customer or commerce docs if unified later'}]
