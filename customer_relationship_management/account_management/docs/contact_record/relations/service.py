"""Relation service seed for contact_record."""
...
RELATED_DOCS = [{'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'account_interaction_log', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account identity from customer_account'}]
