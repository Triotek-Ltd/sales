"""Business-domain service seed for Contact Record."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_customer_account': 'relation_collection', 'related_account_interaction_log': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'contact_code', 'linked_account', 'name'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['customer_account', 'account_interaction_log'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
