"""Relation service seed for account_interaction_log."""
...
RELATED_DOCS = [{'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'contact_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'renewal_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account'}, {'description': 'contact identity from linked records'}]
